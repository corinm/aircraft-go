...
func (m *NatsMessaging) Subscribe(subject string, cb nats.MsgHandler) (*nats.Subscription, error) {
	if m.NatsConn == nil {
		return nil, nats.ErrConnectionClosed
	}
	return m.NatsConn.Subscribe(subject, cb)
}

func (m *NatsMessaging) Drain() error {
	if m.NatsConn == nil {
		return nats.ErrConnectionClosed
	}
	return m.NatsConn.Drain()
}
